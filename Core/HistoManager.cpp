...
//	  G4cout<<"EVENT EMPTY"<<G4endl;
  ...
  fTree->Fill();
//  G4cout<<"trees not filled.........................................: "<<G4endl;
...
void HistoManager::BookHistograms()
{
  ...
  createHistogramWithAxes(
    ...
    "Gamma quanta multiplicity: 2=2g; 3=3g; 5=5g", "Lifetime (2/3g) [ps]"
  );
...
{
//	G4cout<<"No. of vertex: "<< anEvent->GetNumberOfPrimaryVertex()<< G4endl;
...
//	G4cout<<"No. of vertex: "<< anEvent->GetPrimaryVertex(i)->GetNumberOfParticle()<< G4endl;
...
void HistoManager::AddGenInfo(VtxInformation* info)
{
  ...
  if (is2g || is3g || is5g) {
    ...
    fGeantInfo->SetFiveGammaGen(is5g);
