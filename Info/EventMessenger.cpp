...
EventMessenger::EventMessenger()
{
  ...
  fCMDSave4g = new G4UIcmdWithABool("/jpetmc/event/save4g",this);
  fCMDSave4g->SetGuidance("Events with registered 4g will be saved (default false)");
...
void EventMessenger::SetNewValue(G4UIcommand* command, G4String newValue)
{
  ...
  }else if (command == fCMDSave4g) {
    fSave4g = fCMDSave4g->GetNewBoolValue(newValue);
  }
}
